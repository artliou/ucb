...
def largest_factor(n):
    ...
    """
    "*** YOUR CODE HERE ***"
#A is the result of n*n-1
#Start by using b as the first number (n-1), and
#Then checking to see if it is a factor
